...
var hideBoxesOnClick = Array.from(ps);
var hiddenBoxes = hideBoxesOnClick.filter(function (number, index, array) {
  return index === array.indexOf(number);
});
...
box.addEventListener('click', function () {
  ...
  if (this.classList.contains(first)) {
    ...
    hiddenBoxes.forEach(function (node) {
...
box5.addEventListener('click', function () {
  ...
  this.classList.toggle(first);
  setTimeout(function () {
    _this5.classList.toggle(second);
  }, 250);
});
...
var secImg8 = document.getElementById('secImg8');
...
var secImg10 = document.getElementById('secImg10');
...
box10.addEventListener('click', function () {
  ...
  this.classList.toggle(first);
  setTimeout(function () {
    _this10.classList.toggle(second);
  }, 250);
});
...
var secImg11 = document.getElementById('secImg11');
...
box11.addEventListener('click', function () {
  ...
  this.classList.toggle(first);
  setTimeout(function () {
    _this11.classList.toggle(second);
  }, 250);
});
...
var secImg12 = document.getElementById('secImg12');
...
box12.addEventListener('click', function () {
  ...
  this.classList.toggle(first);
  setTimeout(function () {
    _this12.classList.toggle(second);
  }, 250);
});
...
details0.addEventListener('click', function (e) {
  ...
  function myFunction(arr0) {
    ...
    var showJSON0 = function showJSON0() {
