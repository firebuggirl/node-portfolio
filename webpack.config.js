...
const config = {
  entry: {
    ...
    App: [ './public/js/jquery-1.11.2.min.js','./public/js/jquery-2.2.0.min.js','./public/js/bootstrap.min.js', './public/js/certs.js','./public/js/modal.js', './public/js/soundcloud.js', './public/js/animate.js']
